...
if __name__ == '__main__':
    ...
    #                  picture=ProductDB().bimg(img_path=F'{BASE_DIR}/media/taomlar/kartoshka.jpg'))
    #
    # ProductDB().save(name='Tovuqli somsa', price=6000,
    #                  picture=ProductDB().bimg(img_path=F'{BASE_DIR}/media/taomlar/tovuqli.jpg'))
    #
    # ProductDB().save(name='Go`shtli somsa', price=8000,
    #                  picture=ProductDB().bimg(img_path=F'{BASE_DIR}/media/taomlar/gushtli.jpg'))
    #
    # ProductDB().save(name='Kosa somsa', price=25000,
    #                  picture=ProductDB().bimg(img_path=F'{BASE_DIR}/media/taomlar/kosa.jpg'))
